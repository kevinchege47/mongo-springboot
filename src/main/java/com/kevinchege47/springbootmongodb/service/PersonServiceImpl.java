...
import com.kevinchege47.springbootmongodb.repository.PersonRepository;
...
public class PersonServiceImpl implements PersonService {
    ...
    public Page<Person> search(String name, Integer minAge, Integer maxAge, String city, Pageable pageable) {
        ...
        Page<Person> people = PageableExecutionUtils.getPage(mongoTemplate.find(query, Person.class
